...
if __name__ == "__main__":
    assert args.workspace is not None, "workspace is not specified"
    ...
    while True:
        ...
        while True:
            ...
            try:
                ...
                modified_command = f"/bin/bash -c 'source {args.conda_path}/etc/profile.d/conda.sh && conda activate autogpt && cd /{args.workspace} && {command}'"
